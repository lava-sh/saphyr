...
impl Generator {
    ...
    fn gen_record_array<W: std::io::Write>(
        ...
        self.gen_array(writer, items_lo, items_hi, Self::gen_record_object)
    }
    ...
    fn gen_authors_array<W: std::io::Write>(
        ...
        self.gen_array(writer, items_lo, items_hi, Self::gen_author_object)
    }
    ...
    fn gen_array<W: std::io::Write, F: FnMut(&mut Self, &mut W) -> std::io::Result<()>>(
        &mut self,
        writer: &mut W,
        len_lo: usize,
        len_hi: usize,
    ...
    fn nl<W: std::io::Write>(&self, writer: &mut W) -> std::io::Result<()> {
        writeln!(writer)?;
