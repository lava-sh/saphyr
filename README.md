...
to pull changes from and raise patches against original saphyr project.

The parser crate contains many changes. Please refer to parser/README.md for details.
